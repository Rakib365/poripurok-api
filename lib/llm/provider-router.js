  ...
  for (let keyIdx = 0; keyIdx < keys.length; keyIdx++) {
    ...
    while (sameKeyRetries < MAX_RETRIES_PER_KEY) {
      try {
        ...
        const shouldRotateKey = (statusCode >= 500 && statusCode < 600) || statusCode === 429;
        ...
        const shouldRotate = (typeof statusCode === 'number' && statusCode >= 500 && statusCode < 600) || statusCode === 429;
