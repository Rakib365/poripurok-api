...
export async function getRegistry(conversationId) {
  ...
  try {
    ...
    logger.error('local-id-registry load failed', { conversationId, error: err.message });
  }
...
export async function saveRegistry(conversationId) {
  ...
  try {
    ...
    logger.error('local-id-registry save failed', { conversationId, error: err.message });
    throw err;
  }
}
