...
async function loadConversationMeta(userId, convId) {
  ...
  try {
    ...
    console.warn('[ContextLoader] Failed to count conversations:', e.message);
  }
  ...
  if (convId) {
    ...
    try {
      ...
      console.warn('[ContextLoader] Failed to count messages:', e.message);
    }
    ...
    try {
      ...
      console.warn('[ContextLoader] Failed to load conversation title:', e.message);
    }
  }
